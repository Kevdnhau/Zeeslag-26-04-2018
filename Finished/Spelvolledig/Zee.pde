...
class Zee {
  ...
  if (zeeslag3==true){
  if ((575 < mouseY) && (mouseY< 876) && (1225 < mouseX) && (mouseX < 1527 )) {
    image (kruisje, mousex,mousey);}
     tekenkruisje = true; }else tekenkruisje = false;
  
  
  if (zeeslag4==true){
  if ((575 < mouseY) && (mouseY< 876) && (75 < mouseX) && (mouseX < 381 )) {
    image (kruisje, mousex,mousey);}};
  }
